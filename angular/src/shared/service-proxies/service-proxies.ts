...
export class ContactServiceProxy {
     ...
     * @return Success
     */
     get(id: number | undefined): Observable<ContactDto> {
        let url_ = this.baseUrl + "/api/services/app/Contact/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ContactDtoPagedResultDto> {
...
export class GetContactForEditOutput implements IGetContactForEditOutput {
    ...
    init(data?: any) {
        if (data) {
            this.contact = data ? ContactEditDto.fromJS(data) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data = this.contact ? this.contact.toJSON() : <any>undefined;
        return data; 
    }

    clone(): GetContactForEditOutput {
        const json = this.toJSON();
        let result = new GetContactForEditOutput();
        result.init(json);
        return result;
...
export class ContactEditDto implements IContactEditDto {
    name: string | undefined;
    id: number;

    constructor(data?: IContactEditDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ContactEditDto {
        data = typeof data === 'object' ? data : {};
        let result = new ContactEditDto();
        result.init(data);
        return result;
    }
